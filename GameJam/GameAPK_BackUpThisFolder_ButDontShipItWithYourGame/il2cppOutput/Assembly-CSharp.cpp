...
struct Movement_t7ED030E814A2C7E091389CFDABC85C6995DD35E7  : public MonoBehaviour_t532A11E69716D348D8AA7F854AFCBFCB8AD17F71
{
	...
	Rigidbody_t268697F5A994213ED97393309870968BC1C7393C* ___playerRb_10;
};
...
IL2CPP_EXTERN_C IL2CPP_METHOD_ATTR void Movement_Start_m3D09153FD03F06C31BBD151C21BA361EA49FA72B (Movement_t7ED030E814A2C7E091389CFDABC85C6995DD35E7* __this, const RuntimeMethod* method) 
{
	...
	}
	{
		...
		__this->___playerRb_10 = L_0;
		Il2CppCodeGenWriteBarrier((void**)(&__this->___playerRb_10), (void*)L_0);
...
IL_0153:
	...
	{
		bool L_53 = __this->___isGround_7;
		if (!L_53)
		{
			goto IL_01a8;
		}
	}
	{
		...
		Rigidbody_t268697F5A994213ED97393309870968BC1C7393C* L_54 = __this->___playerRb_10;
		Vector3_t24C512C7B96BBABAD472002D0BA2BDA40A5A80B2 L_55;
		L_55 = Vector3_get_up_m128AF3FDC820BF59D5DE86D973E7DE3F20C3AEBA_inline(NULL);
		float L_56 = __this->___force_5;
...
IL_01a8:
	...
	}
	{
		...
		Animator_t8A52E42AE54F76681838FE9E632683EF3952E883* L_59 = __this->___playerAnim_9;
		NullCheck(L_59);
		Animator_SetBool_m6F8D4FAF0770CD4EC1F54406249785DE7391E42B(L_59, _stringLiteral6C23924C4F221C5F81332E79B4BD5A5AF61B9AF7, (bool)0, NULL);
	}

IL_01c1:
	{
		// if (jump == true)
		bool L_60 = __this->___jump_8;
		if (!L_60)
		{
			goto IL_01da;
		}
	}
	{
		...
		Animator_t8A52E42AE54F76681838FE9E632683EF3952E883* L_61 = __this->___playerAnim_9;
		NullCheck(L_61);
		Animator_SetBool_m6F8D4FAF0770CD4EC1F54406249785DE7391E42B(L_61, _stringLiteral6C23924C4F221C5F81332E79B4BD5A5AF61B9AF7, (bool)1, NULL);
	}
...
// System.Void Movement::LateUpdate()
